 ...
 * @author booksaw
 */
public class ReferencedFormatSafeMessage implements Message {
	 ...
	 */
	public ReferencedFormatSafeMessage(String reference, Object... replacements) {
	...
	public void sendMessage(CommandSender recipient) {
		MessageManager.sendSafeReplacedMessage(recipient, reference, replacements);
	}
	...
	public void sendMessage(Collection<? extends CommandSender> recipients) {
		recipients.forEach(r -> MessageManager.sendSafeReplacedMessage(r, reference, replacements));
	}
